...
from hypercane.args.filter_exclude import filter_exclude_parser
...
if __name__ == '__main__':
    ...
    for item in filter_exclude_parser._subparsers._group_actions:
    ...
    args = filter_exclude_parser.parse_args()
